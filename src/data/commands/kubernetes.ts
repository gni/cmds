...
export const kubernetesCommands: TerminalCommand[] = [
  ...
  },
  {
    ...
    title: "Extract & Decode Secret Key",
    description: "Fetch Kubernetes secret and base64 decode target key to stdout.",
  ...
  },
  {
    ...
    title: "Port-Forward Service to Localhost",
    description: "Forward remote Kubernetes service port to your local machine.",
  ...
  {
    id: "k8s-drain-node",
    title: "Cordon & Drain Node for Maintenance",
    description: "Safely evict all workloads from a node with graceful shutdown.",
